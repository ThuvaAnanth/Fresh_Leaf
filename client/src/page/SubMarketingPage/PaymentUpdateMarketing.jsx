...
function PaymentUpdateMarketing() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:3001/server/MarketingPayment/MarketingpaymentgetOne/${id}`)
      .then((result) => {
  ...
  const handleUpdate = (e) => {
    e.preventDefault();
    axios
      .put(`http://localhost:3001/server/MarketingPayment/Marketingpaymentupdate/${id}`, {
        name,
        email,
        cnumber,
        dateyear,
...
export default PaymentUpdateMarketing